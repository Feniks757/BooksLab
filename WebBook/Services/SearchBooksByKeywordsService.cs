...
public class SearchBooksByKeywordsService : ISearchBooksService
{
    ...
    public SearchBooksByKeywordsService(IDbContextFactory<BookContext> contextFactory, IBookSearch bookSearch)
    {
    ...
    public async Task<IEnumerable<Book>> SearchBooksAsync(int userId, string searchQuery)
    {
        ...
        db.UserId = userId;
        return await _bookSearch.SearchAsync(db, searchQuery, (Book book) => "");
    }
}